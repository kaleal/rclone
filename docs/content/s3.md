...
```
	...
	Choose a number from below, or type in your own value
	 1 / US Cross Region Endpoint
   	   \ "s3-api.us-geo.cloud-object-storage.appdomain.cloud"
	 2 / US Cross Region Dallas Endpoint
   	   \ "s3-api.dal.us-geo.cloud-object-storage.appdomain.cloud"
 	 3 / US Cross Region Washington DC Endpoint
   	   \ "s3-api.wdc-us-geo.cloud-object-storage.appdomain.cloud"
	 4 / US Cross Region San Jose Endpoint
	   \ "s3-api.sjc-us-geo.cloud-object-storage.appdomain.cloud"
...
```
	...
	access_key_id = xxx
	secret_access_key = yyy
	endpoint = s3-api.us-geo.cloud-object-storage.appdomain.cloud
